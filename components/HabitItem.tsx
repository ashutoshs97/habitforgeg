      ...
      > 
        ...
        <div>
          <div className="flex items-center space-x-2">
              <h3 className="text-lg font-bold text-neutral dark:text-gray-100">{habit.name}</h3>
              {habit.sharingDetails && <GroupIcon className="w-5 h-5 text-gray-400" title="Shared Habit" />}
          </div>
