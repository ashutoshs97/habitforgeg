        ...
        <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="md:w-2/3">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-yellow-400 font-bold tracking-wider uppercase text-sm">Premium Access</span>
                </div>
                ...
                {!state.user.isPremium && (
                    <button 
                        ...
                        className="bg-white text-gray-900 hover:bg-gray-100 font-bold py-3 px-8 rounded-full text-lg transition-transform transform hover:scale-105 shadow-xl"
                    >
                        Upgrade for $9.99
                    </button>
                )}
