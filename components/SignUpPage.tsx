...
const SignUpPage: React.FC<SignUpPageProps> = ({ onSwitchToSignIn, onGoBack }) => {
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-600 via-indigo-500 to-teal-400 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] relative z-10 flex flex-col">
        ...
        <div className="bg-white dark:bg-neutral-focus rounded-3xl shadow-2xl p-8 md:p-10 animate-pop-in backdrop-blur-sm border border-white/20 dark:border-gray-700">
            <div className="text-center mb-8">
                <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-3 tracking-tight">Create Account</h1>
                <p className="text-gray-500 dark:text-gray-400 text-base">Start forging new habits today.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label htmlFor="name" className="block text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Name</label>
                <input
                  type="text"
                  id="name"
                  value={name}
              ...
              <div className="space-y-2">
                <label htmlFor="email" className="block text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Email</label>
                <input
                  type="email"
                  id="email"
                  value={email}
              ...
              <div className="space-y-2">
                <label htmlFor="password" className="block text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Password (min. 6 chars)</label>
                <input
                  type="password"
                  id="password"
                  value={password}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-primary hover:bg-primary-focus text-white font-bold py-4 rounded-xl shadow-lg shadow-primary/30 transform transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed mt-4 flex items-center justify-center text-lg"
              >
                {isLoading ? (
                     <>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 text-center">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                ...
                <button onClick={onSwitchToSignIn} className="text-primary font-bold hover:underline transition-all">
                  Sign In
                </button>
              </p>
            </div>
